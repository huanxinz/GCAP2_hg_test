...
MODULE gckpp_Monitor
  ...
  CHARACTER(LEN=15), PARAMETER, DIMENSION(90) :: SPC_NAMES_0 = (/ &
     ...
     'CH4            ','H2O2           ','IEPOXOO        ', &
     'MACRNO2        ','PMN            ','MOBAOO         ' /)
  CHARACTER(LEN=15), PARAMETER, DIMENSION(80) :: SPC_NAMES_1 = (/ &
     'ROH            ','DIBOO          ','PRPE           ', &
     'MVKN           ','H              ','BrNO3          ', &
     'Cl2            ','ISNOHOO        ','ISOP           ', &
     'PROPNN         ','ISNOOB         ','HOBr           ', &
     ...
     'MOH            ','N2             ','O2             ', &
     'RCOOH          ','DUMMY          ' /)
  CHARACTER(LEN=15), PARAMETER, DIMENSION(170) :: SPC_NAMES = (/&
    SPC_NAMES_0, SPC_NAMES_1 /)

  INTEGER, PARAMETER, DIMENSION(170) :: LOOKAT = (/ &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_12 = (/ &
     ...
     '       O + BrO --> Br + O2                                                                          ', &
     '      CH2O + O --> CO + HO2 + OH                                                                    ', &
     '     O1D + HCl --> 0.24 H + 0.24 ClO + 0.67 OH + 0.09 O + 0.09 HCl + 0.67 Cl ... etc.               ', &
     '     HBr + O1D --> 0.15 H + 0.65 OH + 0.2 O + 0.65 Br + 0.2 HBr + 0.15 BrO ... etc.                 ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_15 = (/ &
     ...
     '           BrO --> O + Br                                                                           ', &
     '          HOBr --> OH + Br                                                                          ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(26) :: EQN_NAMES_16 = (/ &
     '         BrNO3 --> NO3 + Br                                                                         ', &
     '         BrNO3 --> NO2 + BrO                                                                        ', &
     '         BrNO2 --> Br + NO2                                                                         ', &
     '         CHBr3 --> 3 Br                                                                             ', &
     ...
     '        CH2Br2 --> 2 Br                                                                             ', &
     '          ClOO --> Cl + O2                                                                          ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(506) :: EQN_NAMES = (/&
